            ...
            <div className="flex items-center justify-center gap-1.5 mt-1.5">
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map((s) => (
                  <svg
                    key={s}
                    className={`h-3.5 w-3.5 ${s <= Math.round(rating) ? 'text-amber-400 fill-amber-400' : 'text-gray-300 fill-gray-300'}`}
                    viewBox="0 0 20 20"
                  >
              ...
              <span className="text-xs text-muted-foreground">({reviews_count} avis)</span>
            </div>
          )}
        </div>
      </Link>
