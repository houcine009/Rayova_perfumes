    ...
    public function stats(): JsonResponse
    {
        $stats = [
            ...
            'orders' => [
                ...
                'revenue' => Order::whereIn('status', ['confirmed', 'processing', 'shipped', 'delivered'])->sum('total') - Order::whereIn('status', ['confirmed', 'processing', 'shipped', 'delivered'])->sum('shipping_cost'),
